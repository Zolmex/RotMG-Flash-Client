...
package io.decagames.rotmg.dailyQuests.config
{
    ...
    import io.decagames.rotmg.dailyQuests.view.popup.DailyQuestRefreshPopupMediator;
    import io.decagames.rotmg.dailyQuests.view.popup.DailyQuestExpiredPopup;
    import io.decagames.rotmg.dailyQuests.view.popup.DailyQuestExpirePopupMediator;
    ...
    public class DailyQuestsConfig implements IConfig 
    {
        ...
        public function configure():void
        {
            ...
            this.mediatorMap.map(DailyQuestRefreshPopup).toMediator(DailyQuestRefreshPopupMediator);
            this.mediatorMap.map(DailyQuestExpiredPopup).toMediator(DailyQuestExpirePopupMediator);
            ...
            this.injector.map(CloseExpirePopupSignal).asSingleton();
            this.injector.map(CloseRefreshPopupSignal).asSingleton();
