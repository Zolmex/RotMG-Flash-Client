...
package io.decagames.rotmg.ui.sliceScaling
{
    ...
    public class SliceScalingBitmap extends Bitmap 
    {
        ...
        {
            var _local_1:SliceScalingBitmap = new SliceScalingBitmap(this.bitmapDataToSlice.clone(), this.scaleType, this.scaleGrid, this.fillColor, this.fillColorAlpha);
            _local_1.sourceBitmapName = this._sourceBitmapName;
            return (_local_1);
        }
