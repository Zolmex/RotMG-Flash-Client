...
package io.decagames.rotmg.pets.windows.yard.feed.items
{
    ...
    public class FeedItem extends UIGridElement 
    {
        ...
        private function renderItem():void
        {
            ...
            {
                _local_5 = _local_3.make(new StaticStringBuilder(String(_local_2.Quantity)), 12, 0xFFFFFF, false, new Matrix(), true);
                _local_6 = new Matrix();
                _local_6.translate(8, 7);
                _local_1.draw(_local_5, _local_6);
            }
