...
package io.decagames.rotmg.shop
{
    ...
    public class ShopBoxTag extends Sprite 
    {
        ...
        public function ShopBoxTag(_arg_1:String, _arg_2:String, _arg_3:String, _arg_4:Boolean=false)
        {
            this._color = _arg_2;
            this._name = _arg_1;
            this.background = TextureParser.instance.getSliceScalingBitmap("UI", _arg_2);
