...
package io.decagames.rotmg.shop.mysteryBox.rollModal
{
    ...
    public class MysteryBoxRollModal extends ModalPopup 
    {
        ...
        public function prepareResultGrid(_arg_1:int):void
        {
            ...
            var _local_3:int = int((((_arg_1 / _local_2.x) > 4) ? (this.resultElementWidth * _local_2.y) : -1));
            this.resultGrid = new UIGrid((this.resultElementWidth * _local_2.x), _local_2.x, 0, _local_3);
