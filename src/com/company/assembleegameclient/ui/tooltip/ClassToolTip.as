...
package com.company.assembleegameclient.ui.tooltip
{
    ...
    public class ClassToolTip extends ToolTip 
    {
        ...
        {
            var _local_1:Boolean = Boolean(StaticInjectorContext.injector.getInstance(SeasonalEventModel).isChallenger);
            ...
            if (((this.showUnlockRequirements) && (!(_local_1))))
            {
        ...
        private function createStarProgress():void
        {
            ...
            var _local_1:Graphics = this._progressContainer.graphics;
