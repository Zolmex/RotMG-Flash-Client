...
package com.company.assembleegameclient.appengine
{
    ...
    public class SavedCharactersList extends Event 
    {
        ...
        {
            var _local_3:int;
            var _local_2:BeginnersPackageModel = this.getBeginnerModel();
            if (_arg_1.hasOwnProperty("BeginnerPackageStatus"))
            {
                _local_3 = _arg_1.BeginnerPackageStatus;
                _local_2.status = _local_3;
            }
            else
            {
                _local_2.status = BeginnersPackageModel.STATUS_CANNOT_BUY;
            };
        }
