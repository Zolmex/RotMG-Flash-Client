...
package com.company.assembleegameclient.mapeditor
{
    ...
    public class BigBitmapData 
    {
        ...
        public function copyTo(_arg_1:BitmapData, _arg_2:Rectangle, _arg_3:Rectangle):void
        {
            ...
            var _local_6:int = int(int((_arg_3.x / CHUNK_SIZE)));
            var _local_7:int = int(int((_arg_3.y / CHUNK_SIZE)));
            var _local_8:int = int(Math.ceil((_arg_3.right / CHUNK_SIZE)));
            var _local_9:int = int(Math.ceil((_arg_3.bottom / CHUNK_SIZE)));
        ...
        public function copyFrom(_arg_1:Rectangle, _arg_2:BitmapData, _arg_3:Rectangle):void
        {
            ...
            var _local_6:int = int(Math.max(0, int((_arg_1.x / CHUNK_SIZE))));
            var _local_7:int = int(Math.max(0, int((_arg_1.y / CHUNK_SIZE))));
            var _local_8:int = int(Math.min((this.maxChunkX_ - 1), int((_arg_1.right / CHUNK_SIZE))));
            var _local_9:int = int(Math.min((this.maxChunkY_ - 1), int((_arg_1.bottom / CHUNK_SIZE))));
        ...
        public function erase(_arg_1:Rectangle):void
        {
            ...
            var _local_3:int = int(int((_arg_1.y / CHUNK_SIZE)));
            var _local_4:int = int(Math.ceil((_arg_1.right / CHUNK_SIZE)));
            var _local_5:int = int(Math.ceil((_arg_1.bottom / CHUNK_SIZE)));
