...
package com.company.assembleegameclient.screens
{
    ...
    public class ScoringBox extends Sprite 
    {
        ...
        private var linesSprite_:Sprite = new Sprite();
        private var scoreTextLines_:Vector.<ScoreTextLine> = new Vector.<ScoreTextLine>();
        ...
        public function ScoringBox(_arg_1:Rectangle, _arg_2:XML)
        {
            ...
            this.addLine(TextKey.FAMEVIEW_DUNGEONSCOMPLETED, null, 0, (((((((((((((((((((((((((((((((((((((int(_arg_2.PirateCavesCompleted) + int(_arg_2.UndeadLairsCompleted)) + int(_arg_2.AbyssOfDemonsCompleted)) + int(_arg_2.SnakePitsCompleted)) + int(_arg_2.SpiderDensCompleted)) + int(_arg_2.SpriteWorldsCompleted)) + int(_arg_2.TombsCompleted)) + int(_arg_2.TrenchesCompleted)) + int(_arg_2.JunglesCompleted)) + int(_arg_2.ManorsCompleted)) + int(_arg_2.ForestMazeCompleted)) + int(_arg_2.LairOfDraconisCompleted)) + int(_arg_2.CandyLandCompleted)) + int(_arg_2.HauntedCemeteryCompleted)) + int(_arg_2.CaveOfAThousandTreasuresCompleted)) + int(_arg_2.MadLabCompleted)) + int(_arg_2.DavyJonesCompleted)) + int(_arg_2.TombHeroicCompleted)) + int(_arg_2.DreamscapeCompleted)) + int(_arg_2.IceCaveCompleted)) + int(_arg_2.DeadWaterDocksCompleted)) + int(_arg_2.CrawlingDepthCompleted)) + int(_arg_2.WoodLandCompleted)) + int(_arg_2.BattleNexusCompleted)) + int(_arg_2.TheShattersCompleted)) + int(_arg_2.BelladonnaCompleted)) + int(_arg_2.PuppetMasterCompleted)) + int(_arg_2.ToxicSewersCompleted)) + int(_arg_2.TheHiveCompleted)) + int(_arg_2.MountainTempleCompleted)) + int(_arg_2.TheNestCompleted)) + int(_arg_2.LairOfDraconisHmCompleted)) + int(_arg_2.LostHallsCompleted)) + int(_arg_2.CultistHideoutCompleted)) + int(_arg_2.TheVoidCompleted)) + int(_arg_2.PuppetEncoreCompleted)) + int(_arg_2.LairOfShaitanCompleted)) + int(_arg_2.ParasiteChambersCompleted)), false, 5746018);
        ...
        private function onEnterFrame(_arg_1:Event):void
        {
            ...
            _local_3 = getTimer();
            var _local_4:int = int(Math.min(this.scoreTextLines_.length, (((2 * (getTimer() - this.startTime_)) / 2000) + 1)));
            var _local_5:int;
