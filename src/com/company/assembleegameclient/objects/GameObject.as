...
package com.company.assembleegameclient.objects
{
    ...
    public class GameObject extends BasicObject 
    {
        ...
        public function GameObject(_arg_1:XML)
        {
            ...
            if (_arg_1.hasOwnProperty("SlowImmune"))
            {
        ...
        override public function draw(_arg_1:Vector.<IGraphicsData>, _arg_2:Camera, _arg_3:int):void
        {
            ...
            {
                if (!this.statusFlash_.doneAt(_arg_3))
                {
                    if (Parameters.isGpuRender())
                    {
                        this.statusFlash_.applyGPUTextureColorTransform(_local_4, _arg_3);
                    }
                    else
                    {
                        _local_4 = this.statusFlash_.apply(_local_4, _arg_3);
                    }
                }
                else
                {
