...
package kabam.rotmg.fortune.components
{
    ...
    public class FortuneModal extends EmptyFrame 
    {
        ...
        private var itemSwitchTimer:Timer = new Timer(SWITCH_DELAY_NORMAL);
        ...
        public function FortuneModal(_arg_1:GameSprite=null)
        {
            ...
            this.largeCloseButton.x = ((protected::modalWidth - this.largeCloseButton.width) - 5);
            ...
            this.onHoverPanel.x = (protected::modalWidth - (this.onHoverPanel.width + 10));
        ...
        {
            var _local_5:GTween = new GTween(_arg_1, 0.5, _arg_2, {"ease":Sine.easeOut});
            _local_5.nextTween = new GTween(_arg_1, 0.5, _arg_3, {"ease":Sine.easeIn});
        ...
        private function InitButtons():void
        {
            ...
            this.buyButtonGold.x = (((protected::modalWidth / 2) - 100) - this.buyButtonGold.width);
            this.buyButtonGold.y = (((protected::modalHeight * 70) / 75) - (this.buyButtonGold.height / 2));
            ...
            this.buyButtonFortune.x = ((protected::modalWidth / 2) + 100);
            this.buyButtonFortune.y = (((protected::modalHeight * 70) / 75) - (this.buyButtonFortune.height / 2));
            this.resetButton.x = ((protected::modalWidth / 2) + 100);
            this.resetButton.y = (((protected::modalHeight * 70) / 75) - (this.buyButtonFortune.height / 2));
        ...
        private function setString(_arg_1:int):void
        {
            ...
            _local_2.y = (((protected::modalHeight * 66) / 75) - (_local_2.height / 2));
        ...
        private function onCountdownComplete():void
        {
            ...
            do 
            {
                _local_2 = int(int((Math.random() * 3)));
        ...
        protected function makePlatforms():void
        {
            ...
            this.platformMain.x = (protected::modalWidth / 2);
            ...
            this.platformMainSub.x = (protected::modalWidth / 2);
        ...
        override protected function makeModalBackground():Sprite
        {
            ...
            _local_2.width = protected::modalWidth;
            _local_2.height = protected::modalHeight;
            _local_2.alpha = 0.7;
        ...
        private function onFirstBuySub(_arg_1:int):void
        {
            ...
            if (_local_2 != null)
            {
                ...
                {
                    _local_4 = StaticInjectorContext.getInjector().getInstance(ShowPopupSignal);
        ...
        private function onFirstBuyComplete(_arg_1:Boolean, _arg_2:*):void
        {
            ...
            if (_arg_1)
            {
                ...
                _local_6 = int(Math.floor((Math.random() * 3)));
        ...
        {
            var _local_3:Number;
            var _local_1:int = int(((200 * Math.abs(((int((getTimer() / 2)) % 1000) - 500))) / 1000));
