            ...
            for each (_local_11 in map.goDict_)
            {
                if (!((_local_11.props_.noMiniMap_) || (_local_11 == this.focus)))
                {
                    ...
                    if (_local_17 != null)
                    {
                        ...
                        {
                            if ((((Parameters.data_.newMiniMapColors) && (_local_17.isFellowGuild_)) && (!(_local_17.starred_))))
                            {
                                _local_16 = 0xCF00;
                            }
                            else
                            {
                                if (_local_17.isFellowGuild_)
                                {
                                    _local_16 = 0xFF00;
                                }
                                else
                                {
                                    if ((((Parameters.data_.newMiniMapColors) && (!(_local_17.nameChosen_))) && (_local_17.starred_)))
                                    {
                                        _local_16 = 0xFFFFFF;
                                    }
                                    else
                                    {
                                        if (((Parameters.data_.newMiniMapColors) && (!(_local_17.nameChosen_))))
                                        {
                                            _local_16 = 0xCFCFCF;
                                        }
                                        else
                                        {
                                            if (((Parameters.data_.newMiniMapColors) && (!(_local_17.starred_))))
                                            {
                                                _local_16 = 0xCFCF00;
                                            }
                                            else
                    ...
                    {
                        if ((_local_11 is Character))
                        {
                            if (_local_11.props_.isEnemy_)
                            {
                                if (_local_11.props_.color_ != -1)
                                {
                                    _local_16 = _local_11.props_.color_;
                                }
                                else
                                {
                                    _local_16 = 0xFF0000;
                        ...
                        {
                            if (((_local_11 is Portal) || (_local_11 is GuildHallPortal)))
                            {
                                _local_16 = 0xFF;
                            }
                            else
