...
package kabam.rotmg.game.view
{
    ...
    public class MapOverlayMediator extends Mediator 
    {
        ...
        private function onAddSpeechBalloon(_arg_1:AddSpeechBalloonVO):void
        {
            ...
            var _local_3:SpeechBalloon = new SpeechBalloon(_arg_1.go, _local_2, _arg_1.name, _arg_1.isTrade, _arg_1.isGuild, _arg_1.background, _arg_1.backgroundAlpha, _arg_1.outline, _arg_1.outlineAlpha, _arg_1.textColor, _arg_1.lifetime, _arg_1.bold, _arg_1.hideable);
