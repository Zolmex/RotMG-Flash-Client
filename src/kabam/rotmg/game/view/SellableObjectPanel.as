...
package kabam.rotmg.game.view
{
    ...
    public class SellableObjectPanel extends Panel implements TooltipAble 
    {
        ...
        private function buyEvent():void
        {
            ...
            {
                _local_2 = StaticInjectorContext.getInjector();
                _local_3 = _local_2.getInstance(ShowPopupSignal);
                _local_3.dispatch(new NexusShopPopupView(this.buyItem, this.owner_, this.buyButton_.width, this.availableInventoryNumber));
            }
            else
            {
