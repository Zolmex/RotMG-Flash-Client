...
package kabam.rotmg.messaging.impl
{
    ...
    public class GameServerConnectionConcrete extends GameServerConnection 
    {
        ...
        public function mapMessages():void
        {
            ...
            _local_1.map(RESET_DAILY_QUESTS).toMessage(ResetDailyQuests);
        ...
        private function create():void
        {
            ...
            _local_2.isChallenger = Boolean(this.seasonalEventModel.isChallenger);
        ...
        private function load():void
        {
            ...
            _local_1.isChallenger_ = Boolean(this.seasonalEventModel.isChallenger);
        ...
        override public function playerShoot(_arg_1:int, _arg_2:Projectile):void
        {
            ...
            _local_3.speedMult_ = _arg_2.speedMul_;
            _local_3.lifeMult_ = _arg_2.lifeMul_;
        ...
        public function move(_arg_1:int, _arg_2:uint, _arg_3:Player):void
        {
            ...
            _local_6.records_.length = 0;
            if (((_local_7 >= 0) && ((_local_6.time_ - _local_7) > 125)))
            {
                _local_8 = Math.min(10, gs_.moveRecords_.records_.length);
                _local_9 = 0;
                while (_local_9 < _local_8)
                {
                    if (gs_.moveRecords_.records_[_local_9].time_ >= (_local_6.time_ - 25)) break;
                    _local_6.records_.push(gs_.moveRecords_.records_[_local_9]);
                    _local_9++;
                }
            }
            gs_.moveRecords_.clear(_local_6.time_);
            serverConnection.sendMessage(_local_6);
            ((_arg_3) && (_arg_3.onMove()));
        }
        ...
        private function buyConfirmation(_arg_1:SellableObject, _arg_2:Boolean, _arg_3:int, _arg_4:int, _arg_5:Boolean=false):void
        {
            ...
            var _local_6:Buy = (this.messages.require(BUY) as Buy);
            _local_6.objectId_ = _arg_3;
            _local_6.quantity_ = _arg_4;
            serverConnection.sendMessage(_local_6);
        }
        ...
        private function onAllyShoot(_arg_1:AllyShoot):void
        {
            ...
            if (_local_4 != null)
            {
                _local_5 = _local_4.projectileLifeMul_;
                _local_6 = _local_4.projectileSpeedMult_;
                if (!_arg_1.bard_)
                {
                    _local_5 = 1;
                    _local_6 = 1;
                }
                _local_3.reset(_arg_1.containerType_, 0, _arg_1.ownerId_, _arg_1.bulletId_, _arg_1.angle_, gs_.lastUpdate_, _local_4.projectileIdSetOverrideNew, _local_4.projectileIdSetOverrideOld, _local_5, _local_6);
            }
            else
            {
        ...
        private function onShowEffect(_arg_1:ShowEffect):void
        {
            ...
            switch (_arg_1.effectType_)
            {
                ...
                case ShowEffect.INSPIRED_EFFECT_TYPE:
                    _local_3 = _local_2.goDict_[_arg_1.targetObjectId_];
                    if (((_local_3 == null) || (!(this.canShowEffect(_local_3))))) break;
                    if (((_local_3) && (_local_3.spritesProjectEffect)))
                    {
                        _local_3.spritesProjectEffect.destroy();
                    }
                    _local_2.addObj(new InspireEffect(_local_3, 0xFFBA00, 5), _local_3.x_, _local_3.y_);
                    _local_3.flash_ = new FlashDescription(getTimer(), _arg_1.color_, _arg_1.pos2_.x_, _arg_1.pos2_.y_);
                    _local_4 = new SpritesProjectEffect(_local_3, _arg_1.pos1_.x_);
                    _local_3.spritesProjectEffect = SpritesProjectEffect(_local_4);
                ...
                case ShowEffect.GILDED_BUFF_EFFECT_TYPE:
                    ...
                    _local_8 = 0xFF9A00;
                    _local_9 = 0xA66400;
                    _local_3.flash_ = new FlashDescription(getTimer(), _local_7, 0.5, 9);
                    _local_2.addObj(new GildedEffect(_local_3, _local_7, _local_8, _local_9, 2, 4500), _local_3.x_, _local_3.y_);
                    return;
                case ShowEffect.JADE_BUFF_EFFECT_TYPE:
                    ...
                    _local_11 = 4031656;
                    _local_12 = 4640207;
                    _local_3.flash_ = new FlashDescription(getTimer(), _local_10, 0.5, 9);
                    _local_2.addObj(new GildedEffect(_local_3, _local_10, _local_11, _local_12, 2, 4500), _local_3.x_, _local_3.y_);
                    return;
                case ShowEffect.CHAOS_BUFF_EFFECT_TYPE:
                    ...
                    _local_14 = 11673446;
                    _local_15 = 16659566;
                    _local_3.flash_ = new FlashDescription(getTimer(), _local_13, 0.5, 9);
                    _local_2.addObj(new GildedEffect(_local_3, _local_13, _local_14, _local_15, 2, 4500), _local_3.x_, _local_3.y_);
                    return;
                case ShowEffect.THUNDER_BUFF_EFFECT_TYPE:
                    _local_3 = _local_2.goDict_[_arg_1.targetObjectId_];
                    if (((_local_3 == null) || (!(this.canShowEffect(_local_3))))) break;
                    _local_16 = 16768115;
                    _local_3.flash_ = new FlashDescription(getTimer(), _local_16, 0.25, 1);
                    _local_2.addObj(new ThunderEffect(_local_3), _local_3.x_, _local_3.y_);
                    return;
                case ShowEffect.STATUS_FLASH_EFFECT_TYPE:
                    _local_3 = _local_2.goDict_[_arg_1.targetObjectId_];
                    if (((_local_3 == null) || (!(this.canShowEffect(_local_3))))) break;
                    _local_3.statusFlash_ = new StatusFlashDescription(getTimer(), _arg_1.color_, _arg_1.pos1_.x_);
                    return;
                case ShowEffect.FIRE_ORB_BUFF_EFFECT_TYPE:
                    ...
                    _local_18 = 3675232;
                    _local_19 = 16659566;
                    _local_3.flash_ = new FlashDescription(getTimer(), _local_17, 0.25, 1);
                    _local_2.addObj(new OrbEffect(_local_3, _local_17, _local_18, _local_19, 1.5, 2500, _arg_1.pos1_.toPoint()), _arg_1.pos1_.x_, _arg_1.pos1_.y_);
                    return;
            }
        }
            ...
            for each (_local_7 in _arg_2)
            {
                ...
                switch (_local_7.statType_)
                {
                    ...
                    case StatData.CHALLENGER_STARBG_STAT:
                        _local_4.starsBg_ = ((_local_8 >= 0) ? _local_8 : 0);
                        break;
                    ...
                    case StatData.SUPPORTER_POINTS_STAT:
                        if (_local_4 != null)
                        {
                            ...
                            if (_local_4.objectId_ == this.playerId_)
                            {
                                StaticInjectorContext.getInjector().getInstance(SupporterCampaignModel).updatePoints(_local_8);
                            }
                        }
                        break;
                    ...
                    case StatData.PROJECTILE_LIFE_MULT:
                        _local_4.projectileLifeMul_ = (_local_8 / 1000);
                        break;
                    case StatData.PROJECTILE_SPEED_MULT:
                        _local_4.projectileSpeedMult_ = (_local_8 / 1000);
                        break;
            ...
            if (_local_7)
            {
                ...
                if (_local_7.skinId != _local_10)
                {
                    if (ObjectLibrary.skinSetXMLDataLibrary_[_local_7.skinId] != null)
                    {
                        ...
                        {
                            _local_7.levelUpParticleEffect(int(_local_14));
                        }
        ...
        private function onAoe(_arg_1:Aoe):void
        {
            ...
            if (_local_3)
            {
                _local_4 = GameObject.damageWithDefense(_arg_1.damage_, this.player.defense_, _arg_1.armorPierce_, this.player.condition_);
                _local_5 = null;
                if (_arg_1.effect_ != 0)
                {
        ...
        {
            var _local_1:ResetDailyQuests = (this.messages.require(RESET_DAILY_QUESTS) as ResetDailyQuests);
            serverConnection.sendMessage(_local_1);
        }
        ...
        {
            this.addTextLine.dispatch(ChatMessage.make(Parameters.SERVER_CHAT_NAME, _arg_1.errorDescription_));
            this.retryConnection_ = false;
            gs_.closed.dispatch();
        }

        private function handleServerFull(_arg_1:Failure):void
        {
            this.addTextLine.dispatch(ChatMessage.make(Parameters.SERVER_CHAT_NAME, _arg_1.errorDescription_));
