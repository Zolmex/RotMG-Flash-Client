...
package kabam.rotmg.application.model
{
    ...
    public class DomainModel 
    {
        ...
        private const WHITELIST:Array = PRODUCTION_WHITELIST.concat(TESTING_WHITELIST).concat(TRANSLATION_WHITELIST).concat(TESTING2_WHITELIST).concat(TESTING3_WHITELIST);
