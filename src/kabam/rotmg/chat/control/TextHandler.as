...
package kabam.rotmg.chat.control
{
    ...
    public class TextHandler 
    {
        ...
        public function execute(_arg_1:Text):void
        {
            ...
            var _local_6:String;
            var _local_7:String;
            var _local_2:* = (_arg_1.numStars_ == -1);
            var _local_3:Boolean = (((!(_arg_1.name_ == this.model.player.name_)) && (!(_local_2))) && (!(this.isSpecialRecipientChat(_arg_1.recipient_))));
            var _local_4:Boolean = Boolean(this.seasonalEventModel.isChallenger);
            if ((((!(_local_4)) && (_arg_1.numStars_ < Parameters.data_.chatStarRequirement)) && (_local_3)))
            {
                return;
            };
            ...
            if (((!(Parameters.data_.chatAll)) && (_local_3)))
            {
                if (!((_arg_1.recipient_ == Parameters.GUILD_CHAT_NAME) && (Parameters.data_.chatGuild)))
                {
                    if (!((((!(_local_4)) && (_arg_1.numStars_ < Parameters.data_.chatStarRequirement)) && (!(_arg_1.recipient_ == ""))) && (Parameters.data_.chatWhisper)))
                    {
                        if (!(((_local_4) && (!(_arg_1.recipient_ == ""))) && (Parameters.data_.chatWhisper)))
                        {
                            return;
                        };
                    };
            ...
            if (((_local_2) && (this.isToBeLocalized(_local_5))))
            {
                _local_5 = this.getLocalizedString(_local_5);
            };
            if (((!(_local_2)) && (this.spamFilter.isSpam(_local_5))))
            {
            ...
            if (((_local_2) && (TextureDataConcrete.remoteTexturesUsed == true)))
            {
                ...
                {
                    _local_6 = _arg_1.name_;
                    _local_7 = _arg_1.text_;
                    _arg_1.name_ = "";
                    _arg_1.text_ = "Remote Textures used in this build";
                    this.addTextAsTextLine(_arg_1);
                    _arg_1.name_ = _local_6;
                    _arg_1.text_ = _local_7;
                };
            };
            if (_local_2)
            {
