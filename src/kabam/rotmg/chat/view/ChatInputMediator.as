...
package kabam.rotmg.chat.view
{
    ...
    public class ChatInputMediator extends Mediator 
    {
        ...
        private function processKeyUp(_arg_1:KeyboardEvent):void
        {
            ...
            if (_local_2 == this.chatShortcutModel.getCommandShortcut())
            {
                this.view.activate("/", true);
            }
            else
            {
                if (_local_2 == this.chatShortcutModel.getChatShortcut())
                {
                    this.view.activate(null, true);
                }
                else
                {
                    if (_local_2 == this.chatShortcutModel.getGuildShortcut())
                    {
