...
package kabam.rotmg.dailyLogin.model
{
    ...
    public class DailyLoginModel 
    {
        ...
        public function getFormatedQuestRefreshTime():String
        {
            ...
            var _local_1:TimeSpan = new TimeSpan((this._nextDay.valueOf() - this._currentDate.valueOf()));
            return (((((_local_1.hours > 9) ? _local_1.hours.toString() : ("0" + _local_1.hours.toString())) + "h ") + ((_local_1.minutes > 9) ? _local_1.minutes.toString() : ("0" + _local_1.minutes.toString()))) + "m");
        }
